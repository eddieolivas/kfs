    ...
    <div class="wrap" role="document">
        <div class="content row content-row">
          ...
          <?php 
            ...
            if(strlen($thumb_url) == 0 || $thumb_url == 'http://healthcarewebsite.net/kfs/wp-includes/images/media/default.png') {
              $thumb_url = '/kfs/wp-content/themes/kfs/dist/images/page-header.jpg';
            }
            $title = get_the_title();
