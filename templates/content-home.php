...
<div id="section-4">
	<div class="container">	
		...
		<div class="col-lg-7 gerd-desc">
			<h2>The Kofinas Fertility Group team offers you dedication and experience.</h2>
			<p>George Kofinas, MD, FACOG, our distinguished founder and medical director, and his team of personally trained specialists will uncover the root of your fertility issues and recommend a treatment plan customized to your individual needs. This thorough approach is our secret to successfully giving you the joy of parenthood.</p>

			<p><em>New York Magazine</em> has selected Dr. Kofinas as one of the tri-state area’s “Best Doctors” for all 18 years that the magazine has published this list. Also, he currently serves as the chief of reproductive endocrinology and infertility at New York Methodist Hospital in Brooklyn, New York. By choosing the Kofinas Fertility Group, you can expect to be treated by caring, renowned fertility experts with the skill to give you your best chance at a viable pregnancy and a healthy child.</p>
...
<div id="section-5">
	<div class="row">
		<div class="section-5-left col-lg-8 col-md-12">
			<h2>Leading-edge capabilities and advanced technology define the Kofinas Fertility Group.</h2>
			<p>When it comes to the technology required to properly assess your fertility challenges and take the necessary steps to fix them, Kofinas Fertility Group has no limits. If a new piece of equipment is released and the scientific communmity considers it beneficial to the process of giving our patients a family, then we will spare no resource in order to acquire it.</p>

			<p>Additionally, we incorporate the very latest techniques into our practice. With our vast experience and expertise, we can determine the effectiveness of new and experimental techniques and begin using them immediately, giving our patients the best chance at experiencing parenthood. In fact, Kofinas Fertility Group has a number of “firsts” in the Brooklyn area, meaning we have been successfully performing certain procedures longer than most other fertility doctors, and we use that experience to give you a loving child.</p>
...
<div id="section-7">
	<div class="row">
		...
		<div class="section-7-right col-lg-7 col-md-12">
			...
			<p>Insurance coverage for infertility is often more complicated than other medical treatments, and can vary quite a bit between different plans. For example, sometimes insurance covers infertility testing, but not treatment. At the Kofinas Fertility Group, we do everything we can to keep finances from preventing you from having the child of your dreams, and we are happy to file your insurance claim for you.</p>

			<p>To give you more financial reassurance, we offer a 100% Insured Success IVF program that gives you three in vitro fertilization (IVF) cycles for a set price. And if you fail to achieve a viable 14-week pregnancy after three cycles under this plan, your money will be returned to you in full. Additionally, we offer a number of discount plans for IVF and affordable rates for our many other assessments and therapies.</p>
